    ...
    lifestyle: [
      ...
      },
      {
        ...
        questions: [
          ...
          { id: 3, text: 'Change in Satisfaction Since Pandemic' },
        ],
      },
      {
        name: 'Support Systems & Health Access',
        questions: [
          { id: 4, text: 'Strength of Social Connections' },
          { id: 5, text: 'Access to Quality Healthcare' },
          { id: 6, text: 'Perceived Financial Security' },
    ...
    community: [
      {
        ...
        questions: [
          { id: 8, text: 'Community Support & Adaptation' },
        ],
      },
      {
        name: 'Resource Awareness & Access',
        questions: [
          { id: 9, text: 'Resource Awareness & Access' },
        ],
      },
      {
        name: 'Suggestions for Preparedness',
        questions: [{ id: 10, text: 'Suggestions for Preparedness' }],
      },
    ],
    disruptions: [
      {
